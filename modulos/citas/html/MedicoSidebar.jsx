...
const MedicoSidebar = () => {
    ...
    return (
        <aside className="medico-sidebar" aria-label="Menú del médico">
            ...
            <nav className="medico-sidebar-nav">
                ...
                <NavLink to="/medico/pacientes-historial" className={linkClass}>
                    Pacientes e historias
                </NavLink>
                <NavLink to="/calendario-medico" className={linkClass}>
                    Calendario
                </NavLink>
